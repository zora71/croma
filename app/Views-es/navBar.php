        ...
        <nav>
            <div class="nav-wrapper white">
                ...
                <ul id="nav-mobile" class="right hide-on-med-and-down">
                    ...
                    <!-- bouton de connexion -->
                    <li><a href="#modal2" class="waves-effect waves-light btn green darken-4 tooltipped" data-position="bottom" data-delay="50" data-tooltip="Conexión">Conexión</a></li>
                    ...
                    <li><a href="<?= $this->url('default_deconnexion') ?>" class="waves-effect waves-light btn red darken-4 tooltipped" data-position="bottom" data-delay="50" data-tooltip="Cerrar sesión">Cerrar sesión</a></li>
                ...
                <div id="searchNav" class="nav-wrapper flex">
                    <form id="searchBar">
                        <div id="searchChamp" class="input-field">
                            <input id="search" type="search" placeholder="  Búsqueda..." required>
