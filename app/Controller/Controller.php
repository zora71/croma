...
class Controller extends WController{
	 ...
	 */
    protected $pathViews = '../app/Views-fr';
    ...
    public function show($file, array $data = array())
    {
        ...
        $engine = new \League\Plates\Engine($this->pathViews);
    ...
    public function showForbidden()
    {
        ...
        $file = $this->pathViews.'/w_errors/403.php';
        if(file_exists($file)){
    ...
    public function showNotFound()
    {
        ...
        $file = $this->pathViews.'/w_errors/404.php';
        if(file_exists($file)){
