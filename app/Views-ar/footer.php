...
<div id="modal1" class="modal">
            ...
            <fieldset>
                ...
                <div class="row" style="margin-top: 25px">
                    <div class="col s12 flex-space">
                        <button type="submit" class="waves-effect waves-light btn green darken-4">ثبت</button>
                    </div>
                </div>
            </fieldset>
        </form>
    ...
    <div class="modal-footer">
        <a href="#!" class=" modal-action modal-close waves-effect waves-green btn-flat">اغلق</a>
    </div>
</div>
                    ...
                    <form class="col s12">
                        <div class="row">
                            <div class="input-field col s12">
                                ...
                                <label for="usernameOrEmail">البريد الإلكتروني</label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="input-field col s12">
                        ...
                        <div class="row">
                            <div class="col s12 flex-space">
                                <button type="submit" class="waves-effect waves-light btn green darken-4">تسجيل الدخول</button>
                            </div>
                            <div class="col s12 flex-space">
